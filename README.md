...
Docs: `docs/` (symlinked to `/srv/docs`) · Cursor rules: `.cursor/rules/`
...
| `localhost:4001` | API (Node process) |
| `localhost:3001` | Web (Node process) |
...
**Built:** monorepo boots, health/ready, Prisma foundation models, Redis, sample job, error envelope, S3 adapter stub, role seed, empty domain folders, theme route shells.
