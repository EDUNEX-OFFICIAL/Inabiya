...
async function main() {
  ...
  /** Curated Soft Gift media under /media (verified relevant — avoid random Unsplash IDs). */
  const media = {
  ...
  const homeBlocks = [
    ...
    },
    {
      ...
      props: {
        ...
        limit: 8,
        seeAllHref: '/collections/on-sale',
        seeAllLabel: 'See all',
      },
    },
    {
      ...
      props: {
        ...
        limit: 6,
        seeAllHref: '/collections/editors-picks',
        seeAllLabel: 'See all',
      },
    },
    {
    ...
    },
    {
      ...
      props: {
        ...
        hamper: true,
        limit: 6,
        seeAllHref: '/collections/ready-hampers',
        seeAllLabel: 'See all',
      },
    },
    {
