  ...
  return (
    <main className="gift-page mx-auto max-w-3xl px-gs-4 py-gs-7 sm:px-gs-6">
      ...
      <p className="mt-gs-4 text-body leading-relaxed opacity-90">
        Inabiya Soft Gift is built for new parents and the people who love them — curated
        baby-safe brands, personalised keepsakes, and ready-made hampers that arrive with care.
      </p>
      <p className="mt-gs-4 text-body leading-relaxed opacity-90">
        We believe gifting should be gentle: fewer decisions, clearer choices, and boxes you
        would be proud to unwrap. From Build Your Box to corporate bulk orders, every path stays
        soft, thoughtful, and India-ready.
      </p>
