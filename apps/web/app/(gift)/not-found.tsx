...
export default function GiftNotFound() {
  return (
    <main className="relative mx-auto flex min-h-[70vh] max-w-3xl flex-col items-center justify-center overflow-hidden px-gs-4 py-gs-8 text-center sm:px-gs-6">
      ...
      <h1 className="gift-display relative mt-gs-3 text-primary">This gift got lost in the wrap</h1>
      ...
      <p className="relative mt-gs-8 font-display text-6xl text-primary/20" aria-hidden>
        ♡
      </p>
    </main>
  );
