...
export function CorporateHero() {
  ...
  return (
    <section ref={containerRef} className="gift-hero-split relative overflow-hidden">
      ...
      <div className="gift-hero-split__grid relative z-10 mx-auto grid max-w-6xl items-center gap-gs-6 px-gs-4 py-gs-7 sm:px-gs-6 sm:py-gs-8 lg:grid-cols-2 lg:gap-gs-8">
